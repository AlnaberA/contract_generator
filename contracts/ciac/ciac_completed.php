<?php
  $sql = "SELECT * FROM CONTRACT_GEN_CIO2 WHERE STATUS = 'COMPLETED' ORDER BY DATE_SUBMITTED DESC";
  ...
  $table = "
    ...
    if($count == 0){
      $table.= "
          <tr>
            <td colspan='7'><div class='alert alert-warning'>There are no completed contracts</div></td>
          </tr>";
    }
