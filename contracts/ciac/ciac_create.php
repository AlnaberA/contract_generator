...
<form role="form" action="contracts/ciac/preview.php" target="_blank" method="post" id="contract_form">
  <div class="container" style="padding-bottom: 70px;">
    <div class="page-header">
      <h2 style="color: #666666;">Commercial/Industrial Option 2 Form</h2>
    </div>
    <div class="col-md-4">
        ...
        <div class="panel-body">
            ...
            <div id="site_info">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="city_site" name="city_site" placeholder="City/Twnship/Village">
              </div>
            </div>
           <div class="form-group">
      ...
      <div class="panel panel-orange panel-shadow form-top">
        ...
        <div class="panel-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="cc_wo_num" name="cc_wo_num" placeholder="CC WO Number">
            </div>
<!--        <div class="form-group">
              <label for="agreement_num">Agreement Number:</label>
              <input type="text" class="form-control" id="agreement_num" name="agreement_num" placeholder="Agreement Number">
            </div>-->
            <div class="form-group">
            ...
            <hr class="hr-no-spacing-top"><h4 class="form-group-heading">Construction Details</h4><hr class="hr-no-spacing-bottom">
              <div class="form-horizontal" style="padding-top: 0px;">
                <div class="form-group">
                  ...
                  <div class="col-md-5">
                    <input type="text" class="form-control" id="trench_length" name="trench_length" placeholder="Feet">
                  </div>
                </div>
                <div class="form-group">
                  <label for="add_trans_load" class="checkbox inline col-md-7">Add'l. Transformer Load:</label>
                  <div class="col-md-5">
                    <input type="text" class="form-control" id="add_trans_load" name="add_trans_load" placeholder="kVA">
                  </div>
                </div>
                <div class="form-group">
                  <label for="winter_const" class="checkbox inline col-md-7">Winter Construction Installation:</label>
                  <div class="col-md-5">
                    <input type="text" class="form-control" id="winter_const" name="winter_const" placeholder="Feet">
                  </div>
                </div>
              </div><br>
            ...
            <hr class="hr-no-spacing-top"><h4 class="form-group-heading">Standard Allowance</h4><hr class="hr-no-spacing-bottom">
              <div class="form-horizontal" style="padding-top: 0px;">
                <div class="form-group">
                  ...
                  <div class="col-md-5">
                    <input type="text" class="form-control" id="ann_use" name="ann_use" placeholder="kWh">
                  </div>
                </div><br><br><br><br>
                <div class="form-group">
                  <label for="ciac_credit" class="checkbox inline col-md-7">Option 2 CIAC Credit (D3): </label>
                  <div class="col-md-5">
                    <input type="text" class="form-control" id="ciac_credit" name="ciac_credit" placeholder="$" readonly>
                  </div>
                </div>
              </div>
          </div>
          ...
          <div class="col-md-6">
            ...
            <div class="form-horizontal" style="padding-top: 0px;">
                <div class="form-group">
                  ...
                  <div class="col-md-5">
                    <input type="text" class="form-control" id="construct_cost" name="construct_cost" placeholder="$">
                  </div>
                </div>
                <div class="form-group">
                  <label for="permits_row" class="checkbox inline col-md-7">Acquiring Permits/Right-of-Way:</label>
                  <div class="col-md-5">
                    <input type="text" class="form-control" id="permits_row" name="permits_row" placeholder="$">
                  </div>
                </div>
                <div class="form-group">
                  <label for="ug_vs_oh" class="checkbox inline col-md-7">UG vs OH Perimeter/Offsite Ext.:</label>
                  <div class="col-md-5">
                    <input type="text" class="form-control" id="ug_vs_oh" name="ug_vs_oh" placeholder="$">
                  </div>
                </div>
                <div class="form-group">
                  <label for="system_mod_cost" class="checkbox inline col-md-7">System Modification Cost:</label>
                    <div class="col-md-5">
                      <input type="text" class="form-control" id="system_mod_cost" name="system_mod_cost" placeholder="$">
                    </div>
                </div> 
                <div class="form-group">
                  <label for="add_construct_cost" class="checkbox inline col-md-7">Additional Construction Costs:</label>
                  <div class="col-md-5">
                    <input type="text" class="form-control" id="add_construct_cost" name="add_construct_cost" placeholder="$">
                  </div>
                  <div class="col-md-7">
                    <input type="text" class="form-control" id="add_construct_cost_reason" name="add_construct_cost_reason" placeholder="Work Done">
                  </div>
                </div>
    ...
    <br>
    <center><input type="submit" value="Preview" class="btn btn-info btn-lg" />&emsp; &emsp;
    <button type="button" class="btn btn-default btn-lg" id="save_btn">Save</button>&emsp; &emsp;
    <button type="button" class="btn btn-success btn-lg" id="submit_modal" data-toggle="modal" data-target="#ac_comment_modal">Submit</button>
    </form>
  ...
  <script>
    function get_planner_initial(){
      var userid = $('input[name=userid]').val();

      $.ajax({
        type: "POST",
        url: "contracts/ciac/form_actions/select_planner_initial.php",
        data:{
          userid: userid
        },
...
<div id="ac_comment_modal" class="modal fade" role="dialog">
