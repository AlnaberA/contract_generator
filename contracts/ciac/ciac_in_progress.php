...
$sql = "SELECT * FROM CONTRACT_GEN_CIO2 WHERE SAVED_BY = '{$userId}' AND (STATUS = 'SAVED' OR STATUS = 'PENDING' OR STATUS = 'ASSIGNED') ORDER BY STATUS, CUST_NAME DESC";
  ...
  $table = "
    ...
    {   
      ...
      $table .= " 
          ...
          $table .= "<td style='width: 13.5%;'><a target='_blank' href='contracts/ciac/view_contract.php?id=".$row['ID']."&preview=true' id='preview_saved_contract_btn' class='btn btn-info btn-sm'>Preview</a></td>"; 
