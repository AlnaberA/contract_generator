<?
	...
	else if(strpos($row['WORK_LOCATION'], 'Walker Cisler Building') !== false) {
		$region_planner = "SE";
	...
	if ($region_planner == "" && $address_planner == "" && $address_planner2 == ""){
		$output = "<div class='alert alert-danger'><strong>Alert: </strong>Could not find current user in the Planners list. Please select one above.</div>";
