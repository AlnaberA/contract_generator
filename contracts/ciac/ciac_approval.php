...
?>
  ...
  <center>
    <div style="margin-top: 20px;">
        <iframe src="contracts/ciac/view_contract.php?id=<? echo $id ?>&preview=false" style="height: 700px; width: 1000px;" wmode="Opaque"></iframe>
    </div><br>
  </center>
...
<div class="row">
  ...
  <div class="col-md-4">
      ...
      <br><div style="float: right;"><button type="button" class="btn btn-danger" id="not_approved_submit_btn" style="margin-bottom: 100px; margin-top: 25px;">Reject</button></div>
  </div>
  <div class="col-md-4"></div>
</div>
