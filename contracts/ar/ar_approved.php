<?php
  $sql = "SELECT * FROM CONTRACT_GEN_AR WHERE STATUS = 'APPROVED' ORDER BY DATE_SUBMITTED DESC";
  ...
  $table = "
    ...
    if($count == 0){
      $table.= "
          <tr>
            <td colspan='6'><div class='alert alert-warning'>There are no approved contracts</div></td>
          </tr>";
    }
