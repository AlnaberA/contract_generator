<?php
    ...
    $sql = "SELECT * FROM CONTRACT_GEN_AR WHERE ID = '{$btn_id}'";
    $row = $db->fetch($sql);
...
?>
    ...
    <center>
        <div class="modal-header">
          ...
          <b>Work Order # <?echo $row['WONUM'];?></b>
        </div>
            <div class="modal-body">
                <label for="currently_assigned">Currently Assigned To:</label>
                <input class="form-control text-center" type="text" placeholder="Name" value="<?echo $row['CREATED_BY']?>" style="width:40%" readonly>
            </div>
            <div class="modal-body">
